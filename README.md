...
* C언어로 PS 문제들 구현하는 것은 다른 언어와 달리 난이도가 있었습니다. 파이썬으로 한 친구의 경우엔 편리하게 사용할 수 있도록 지원하는 함수가 더 많고 문법도 짧게 사용할 수 있어서 더 편하게 풀고 구현할 수 있었습니다. 하지만 C언어로 구현하는 것은 문법이 복잡하여 파이썬과 같은 언어와 비교해 시간이 오래걸리고 난이도가 높았습니다. 하지만 완성했을 경우 실행 속도는 C언어가 월등히 빨랐습니다.
